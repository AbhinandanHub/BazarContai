                  ...
                  <div class="col-xxl-12">
                     <div class="breadcrumb__content p-relative z-index-1">
                        <div class="breadcrumb__list has-icon">
                           ...
                           <span><a href="categories.php">Collections</a></span>
            ...
            <div class="tp-product-details-top pb-115">
               <div class="container product_data">
                  <div class="row">
                        ...
                        <div class="tp-product-details-thumb-wrapper tp-tab d-sm-flex">
                           <nav>
                              ...
                              <button class="nav-link active" id="nav-1-tab" data-bs-toggle="tab" data-bs-target="#nav-1" type="button" role="tab" aria-controls="nav-1" aria-selected="true">
                                 ...
                                 <button class="nav-link" id="nav-2-tab" data-bs-toggle="tab" data-bs-target="#nav-2" type="button" role="tab" aria-controls="nav-2" aria-selected="false"> <!--product left nav image-->
                                    <img src="uploads/<?= $product['image'];?>" alt="Product Image">
                           ...
                           <div class="tab-pane fade show active" id="nav-1" role="tabpanel" aria-labelledby="nav-1-tab" tabindex="0">
                                 ...
                                 <img src="uploads/<?= $product['image'];?>" alt="Product Image" style="width:570px; height:650px;">
                              ...
                              <div class="tab-pane fade show" id="nav-2" role="tabpanel" aria-labelledby="nav-2-tab" tabindex="0">
                                 <div class="tp-product-details-nav-main-thumb">
                                 <img src="uploads/<?= $product['image'];?>" alt="Product Image" style="width:570px; height:650px;"> <!--product main image-->
                     ...
                     <div class="col-xl-5 col-lg-6"> <!--product_data class is for product quantity inc or dec in custom.js-->
                           <div class="tp-product-details-wrapper"> 
                              <div class="tp-product-details-category">
                                 <span class="text-danger"><a href="categories.php"> <?php if($product['trending']) { echo "Trending"; } ?> </a></span>
                              </div>
                              <h3 class="tp-product-details-title"><?= $product['name'];?></h3> <!--product main title-->
                              ...
                              <p><?= $product['small_description'];?></p> <!--product small Description-->
      
                              <!-- price -->
                              <div class="tp-product-details-price-wrapper mb-20">
                                 <span class="tp-product-details-price old-price"> Rs <?= $product['original_price'];?></span> <!--class="text-success fw-bold"-->
                                 <span class="tp-product-details-price new-price"> Rs <?= $product['selling_price'];?></span>
                              </div>
                              ...
                              <div class="tp-product-details-action-wrapper">
                                 ...
                                 <div class="tp-product-details-action-item-wrapper d-flex align-items-center">
                                    ...
                                    <!-- <div class="tp-product-details-quantity">
                                       <div class="tp-product-quantity mb-15 mr-15">
                                          <span class="tp-cart-minus" class="decrement-btn">  class="increment-btn" and  class="decrement-btn" is let for custo.js
                                             <svg width="11" height="2" viewBox="0 0 11 2" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M1 1H10" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                             </svg>                                                            
                                          </span>
                                          
                                          <input class="tp-cart-input" type="text" class="input-qty" value="1">

                                          <span class="tp-cart-plus" class="increment-btn">
                                    ...
                                    <div class="tp-product-details-quantity">
                                       ...
                                       <div class="input-group mb-3" style="width:130px">
                                          ...
                                          <input type="text" class="form-control text-center input-qty bg-white" value="1" readonly>
                                    ...
                                    <div class="tp-product-details-add-to-cart mb-15 w-100">
                                       <button class="tp-product-details-add-to-cart-btn w-100 tp-product-details-buy-now-btn addToCartBtn" value="<?= $product['id'];?>">Add To Cart</button>
                                    </div>
                                 </div>
                                 <!-- <a href="checkout.php">
                                 ...
                                 <!-- <form action="buy_now.php" method="POST">
                                    ...
                                    <button type="submit" class="placeOrderBtn">Buy Now</button>
                                 </form> -->
                                       ...
                                       <div class="col-xl-10">
                                             ...
                                             <div class="row">
                                                <div class="col-lg-6">
                                                   <div class="tp-product-details-desc-content pt-25">
                                                      <span><?= $product['name'];?></span>  <!--one more time title  -->
                                                   ...
                                                   <div class="tp-product-details-desc-content">
                                                      <h3 class="tp-product-details-desc-title">Imagination anytime anywhere</h3>
                                                      <p><?= $product['description'];?></p>
                                                ...
                                                <div class="col-lg-6">
                                                   <div class="tp-product-details-desc-thumb">
                                                      <img src="uploads/<?= $product['image'];?>" alt="Product Image" style="width:500px; height:427px;">
                                          ...
                                          <div class="tp-product-details-desc-item  pb-75">
                                             <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                   <div class="tp-product-details-desc-thumb">
                                                      <img src="uploads/<?= $product['image'];?>" alt="Product Image" style="width:590px; height:349px;">
                                             ...
                                             <div class="row">
                                                <div class="col-xl-12">
                                                   <div class="tp-product-details-desc-banner text-center m-img">
                                                      <h3 class="tp-product-details-desc-banner-title tp-product-details-desc-title">Live with style and comfort</h3>
                                                      <img src="uploads/<?= $product['image'];?>" alt="Product Image" style="width:792px; height:364px;">
   ...
   else
      {
         echo "
            <div style='display: flex; flex-direction: column; align-items: center; justify-content: center; height: 100vh; text-align: center;'>
               <div style='font-size: 50px; color: #ff0000; margin-bottom: 10px;'>
                  &#9888; <!-- Warning icon -->
               </div>
