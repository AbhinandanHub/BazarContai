...
<!-- start: if a already Registered user try to register again then this alert will be shown -->
...
if(isset($_SESSION['auth']))
{
   ...
   exit(); //this page (means the rest of bello codes like- in bellow this line "unset($_SESSION['message']);" not execute in this page) is not continue execute After this line.
}
?>

 <!-- End: if a already Registered user try to register again then this alert will be shown -->
      ...
      <main>
         ...
         <section class="tp-login-area pb-140 p-relative z-index-1 fix">
            ...
            <!--if password and confirm password do not match then alert-->
...
<form action="functions/authcode.php" method="POST"><!--functions/authcode.php -->
                  ...
                  <div class="col-xl-6 col-lg-8">
                     <div class="tp-login-wrapper">
                        <div class="tp-login-top text-center mb-30">
                           <h3 class="tp-login-title">Sign Up BazarContai.</h3>
...
<!--alert end-->
                              ...
                              <div class="tp-login-input-box">
                                 <div class="tp-login-input">
                                    <!-- <input id="name" type="text" placeholder="Enter Name" name="name" value="<?php if(isset($name)) {echo $name;} ?>"> -->
                                    <input id="name" type="text" placeholder="Enter Name" name="name" value="<?php echo isset($_SESSION['form_data']['name']) ? $_SESSION['form_data']['name'] : ''; ?>">
                              ...
                              <div class="tp-login-input-box">
                                 <div class="tp-login-input">
                                    <!-- <input id="phone" type="tel" placeholder="9339052458" name="phone"> -->
                                    <input id="phone" type="tel" placeholder="9339052458" name="phone" value="<?php echo isset($_SESSION['form_data']['phone']) ? $_SESSION['form_data']['phone'] : ''; ?>">
                                 </div>
                                 <div class="tp-login-input-title">
                              ...
                              <div class="tp-login-input-box">
                                 <div class="tp-login-input">
                                    <!-- <input id="email" type="email" placeholder="BazarContai@mail.com" name="email"> -->
                                    <input id="email" type="email" placeholder="BazarContai@mail.com" name="email" value="<?php echo isset($_SESSION['form_data']['email']) ? $_SESSION['form_data']['email'] : ''; ?>">
                                 </div>
                                 <div class="tp-login-input-title">
                              ...
                              <div class="tp-login-input-box">
                                 <div class="tp-login-input">
                                    ...
                                    <input id="tp_password" type="password" placeholder="Min. 6 character" name="password" value="<?php echo isset($_SESSION['form_data']['password']) ? $_SESSION['form_data']['password'] : ''; ?>">
                                 </div>
                              ...
                              <div class="tp-login-input-box">
                                 <div class="tp-login-input">
                                    <!-- <input id="tp_password" type="password" placeholder="Min. 6 character" name="cpassword"> -->
                                    <input id="tp_password" type="password" placeholder="Min. 6 character" name="cpassword">
                                 </div>
                                 <div class="tp-login-input-eye" id="password-show-toggle">
                                    <span id="open-eye" class="open-eye">
                           ...
                           <div class="tp-login-bottom">
                            <button name="register_btn" type="submit" class="tp-login-btn w-100">Sign Up</button>  <!-- here the php logic code write in functions/authcode.php file -->
                              <!-- <a href="#" class="tp-login-btn w-100">Sign Up</a> -->
                              <!-- <button name="register_btn" type="submit" class="tp-login-btn w-100">Sign Up</button> -->
                                 <!-- <a href="index.php"><button name="register_btn" type="submit" value="submit" class="tp-login-btn w-100" onclick="return validateForm()">Sign Up</button></a> -->
                                 <!-- <input type="submt" class="tp-login-btn w-100" name="signup_btn" value="Sign Up"> -->
                              </div>
                        </div>
                     </div>
                  </div>
