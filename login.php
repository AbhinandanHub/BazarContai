...
<!-- start: if a already logged in user try to login again then this alert will shown -->
...
?>
 ...
 <!-- End: if a already logged in user try to login again then this alert will shown -->
                  ...
                  <div class="col-xl-6 col-lg-8">
                     <div class="tp-login-wrapper">
                        <div class="tp-login-top text-center mb-30">
                           <h3 class="tp-login-title">Login to BazarContai.</h3>
...
<!--alert end-->
                           ...
                           <div class="tp-login-bottom">
                              <!-- <a href="profile.html" class="tp-login-btn w-100" type="submit" name="login_btn">Login</a> -->
                              <button href="index.php" class="tp-login-btn w-100" type="submit" name="login_btn">Login</button>
