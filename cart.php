                           ...
                           <div class="tp-cart-list mb-25 mr-30">
                              ...
                              <table class="table">
                                 ...
                                 <tr>
                                    ...
                                    <th class="tp-cart-header-quantity">Action</th>
                                 </tr>
                                 </thead>
                                       ...
                                       ?>   
                                          ...
                                          <tbody>  
                                             <tr class="product_data">  <!-- "product_data" is used for inc and dec the quantity btn (like as product-view.php page we are done it)  -->
                                                ...
                                                <!-- title -->
                                                <td class="tp-cart-title"><a href="product-details.html"> <?= $citem['name'] ?> </a></td>
                                                <!-- price -->
                                                ...
                                                <td class="tp-cart-action">
                                                   <button class="tp-cart-action-btn deleteItem" value="<?= $citem['cid'] ?>"> <!--here "deleteItem" perform as jqclick event under custom.js-->
                                                      <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6">
                           <div class="tp-cart-checkout-wrapper">
                              <div class="tp-cart-checkout-top d-flex align-items-center justify-content-between">
                                 ...
                                 <span class="tp-cart-checkout-top-title">Great Shopping</span>
                                 <span class="tp-cart-checkout-top-price"><i class="fa-solid fa-gift"></i></span>
                              </div>
...
<!-- To better understanding some concepts which are used in this cart.php page -->
         <!-- <?php $items = getCartItems(); //This is the main concept to fetch the data
      foreach ($items as $citem){   
         echo $citem['name'];
      }
      ?> 37,39,57-->