...
{
    if(isset($_POST['scope'])) //this line for, if the user access this page through url then show the error like 'something went wrong'
    {
        $scope = $_POST['scope'];
        switch ($scope)
        {
            ...
            //for update the inc or dec qty in cart.php
            case "update":
                $prod_id = $_POST['prod_id'];
                $prod_qty = $_POST['prod_qty'];
