               ...
               <div class="row">
                  <div class="col-xxl-12">
                     <div class="breadcrumb__content p-relative z-index-1">
                        <h3 class="breadcrumb__title">Trending Collections</h3>
                     ...
                     <div class="tp-banner-item tp-banner-height has-square p-relative mb-30 z-index-1 fix">
                        ...
                        <div class="tp-banner-content">
                           ...
                           <h3 class="tp-banner-title">
                              <a href="product-details.html">Smartphone <br> BLU G91 Pro 2024</a>
                           </h3>
...
?> -->
                     ...
                     <div class="tp-category-main-box mb-25 p-relative fix" data-bg-color="#F3F5F7">
                        ...
                        <div class="tp-category-main-content">
                           <h3 class="tp-category-main-title">
                              <a href="products.php">Headphones</a>
                           </h3>
                  ...
                  <!-- <div class="col-lg-4 col-sm-6">
                     <div class="tp-category-main-box mb-25 p-relative fix" data-bg-color="#F3F5F7">
                        ...
                        <div class="tp-category-main-content">
                           <h3 class="tp-category-main-title">
                              <a href="products.php">Smart Watches</a>
                           </h3>
                  ...
                  <div class="col-lg-4 col-sm-6">
                     <div class="tp-category-main-box mb-25 p-relative fix" data-bg-color="#F3F5F7">
                        ...
                        <div class="tp-category-main-content">
                           <h3 class="tp-category-main-title">
                              <a href="products.php">Smart Phones</a>
                           </h3>
                  ...
                  <div class="col-lg-4 col-sm-6">
                     <div class="tp-category-main-box mb-25 p-relative fix" data-bg-color="#F3F5F7">
                        ...
                        <div class="tp-category-main-content">
                           <h3 class="tp-category-main-title">
                              <a href="products.php">Desktop Computer</a>
                           </h3>
                  ...
                  <div class="col-lg-4 col-sm-6">
                     <div class="tp-category-main-box mb-25 p-relative fix" data-bg-color="#F3F5F7">
                        ...
                        <div class="tp-category-main-content">
                           <h3 class="tp-category-main-title">
                              <a href="products.php">Bluetooth Earphones</a>
                           </h3>
                  ...
                  <div class="col-lg-4 col-sm-6">
                     <div class="tp-category-main-box mb-25 p-relative fix" data-bg-color="#F3F5F7">
                        ...
                        <div class="tp-category-main-content">
                           <h3 class="tp-category-main-title">
                              <a href="products.php">Wireless Headphones</a>
                           </h3>
                  ...
                  <div class="col-lg-4 col-sm-6">
                     <div class="tp-category-main-box mb-25 p-relative fix" data-bg-color="#F3F5F7">
                        ...
                        <div class="tp-category-main-content">
                           <h3 class="tp-category-main-title">
                              <a href="products.php">Gaming Console</a>
                           </h3>
                  ...
                  <div class="col-lg-4 col-sm-6">
                     <div class="tp-category-main-box mb-25 p-relative fix" data-bg-color="#F3F5F7">
                        ...
                        <div class="tp-category-main-content">
                           <h3 class="tp-category-main-title">
                              <a href="products.php">CPU Coolers</a>
                           </h3>
                  ...
                  <div class="col-lg-4 col-sm-6">
                     <div class="tp-category-main-box mb-25 p-relative fix" data-bg-color="#F3F5F7">
                        ...
                        <div class="tp-category-main-content">
                           <h3 class="tp-category-main-title">
                              <a href="products.php">Playstation</a>
                           </h3>
   ...
   foreach($categories as $item)
   {
      ?>
                     ...
                     <div class="tp-category-main-box mb-25 p-relative fix" data-bg-color="#F3F5F7">
                        ...
                        <div class="tp-category-main-content">
                           <h3 class="tp-category-main-title">
                              <a href="products.php?category=<?= $item['slug'];?>"><h4><?= $item['name'];?></h4></a> 
                           </h3>
                           <span class="tp-category-main-item">07 Products</span>
                        </div>
                     </div>
               ...
               <div class="row">
                  <div class="col-xl-12">
                     ...
                     <div class="tp-category-main-more text-center">
                        <a href="products.php" class="tp-load-more-btn">
                           Load More 
