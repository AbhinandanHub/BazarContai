                           ...
                           <div class="tab-pane fade show active" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                              <div class="profile__main">
                                 <div class="profile__main-top pb-80">
                                       ...
                                       <div class="col-md-6">
                                          <div class="profile__main-inner d-flex flex-wrap align-items-center">
                                             ...
                                             <div class="profile__main-content">
                                                <h3 class="profile__main-title">Welcome To BazarContai!</h3>
                                                <p>You have <span>08</span> notifications</p>
                                             </div>
                                          </div>
                                       </div>

                                    <!--start: if A already Login user press the Logout Button in profile.php , then the user return the index.php (without register/login) page. (php code of logout under logoutphp file) -->
                                    ...
                                    <!--End: if A already Login user press the Logout Button in profile.php , then the user return the index.php (without register/login) page. -->
                                    ...
                                    <form action="#">
                                       <div class="row">
                                          ...
                                          <div class="col-xxl-6 col-md-6">
                                             <div class="profile__input-box">
                                                <div class="profile__input">
                                                   <input type="email" placeholder="Enter your email" value="@mail.com">
                                                   <span>
                                          ...
                                          <div class="col-xxl-6 col-md-6">
                                             <div class="profile__input-box">
                                                <div class="profile__input">
                                                   <input type="text" placeholder="Enter username" value="fname">
                                                   <span>
                                          ...
                                          <div class="col-xxl-6 col-md-6">
                                             <div class="profile__input-box">
                                                <div class="profile__input">
                                                   <input type="text" placeholder="Enter your number" value="9339024892">
                                                   <span>
                                          ...
                                          <div class="col-xxl-12">
                                             <div class="profile__input-box">
                                                <div class="profile__input">
                                                   <input type="text" placeholder="Enter your address" value="India">
                                                   <span>
