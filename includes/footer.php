                     ...
                     <div class="col-xl-4 col-lg-3 col-md-4 col-sm-6">
                        <div class="tp-footer-widget footer-col-1 mb-50">
                           <div class="tp-footer-widget-content">
                              ...
                              <p class="tp-footer-desc">created a stunning BazarContai ecommerce</p>
                        ...
                        <div class="tp-footer-widget footer-col-4 mb-50">
                           ...
                           <div class="tp-footer-widget-content">
                              <div class="tp-footer-talk mb-20">
                                 ...
                                 <h4><a href="tel:670-413-90-762">+91 9339024892</a></h4>
                              </div>
                              <div class="tp-footer-contact">
                                 <div class="tp-footer-contact-item d-flex align-items-start">
                                    ...
                                    <div class="tp-footer-contact-content">
                                       <p><a href="https://html.weblearnbd.net/cdn-cgi/l/email-protection#2152494e475861525451514e53550f424e4c"><span class="__cf_email__" data-cfemail="2053484f465960535550504f52540e434f4d">bazarcontai@gmail.com</span></a></p>
                                    </div>
                                 </div>
                                 <div class="tp-footer-contact-item d-flex align-items-start">
                                    <div class="tp-footer-contact-icon">
                                    ...
                                    <div class="tp-footer-contact-content">
                                       <p><a href="https://www.google.com/maps/place/Sleepy+Hollow+Rd,+Gouverneur,+NY+13642,+USA/@44.3304966,-75.4552367,17z/data=!3m1!4b1!4m6!3m5!1s0x4cccddac8972c5eb:0x56286024afff537a!8m2!3d44.3304928!4d-75.453048!16s%2Fg%2F1tdsjdj4" target="_blank">Central bypass. <br> Contai, India 721427</a></p>
                                    </div>
                                 </div>
                              </div>
                           </div>
                     ...
                     <div class="row align-items-center">
                        <div class="col-md-6">
                           <div class="tp-footer-copyright">
                              <p>© <?=date('Y')?>  |  created by <a href="index.php" target="_blank">BazarContai Management Team</a>.</p> <!--target="_blank" means when anyone click this link then it open in a new Tab browser-->
                           </div>
                        </div>
                        <div class="col-md-6">
     ...
     <script src="assets/js/meanmenu.js"></script>    <!--this is for color change settings -->
   ...
   <!-- Start: Admin Page Alert message show -->
    <!--Alertyfy js -->
   ...
   <!-- End: Admin Page Alert message show -->
