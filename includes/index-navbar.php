...
<!--if Logged In Successfully then alert-->
         ...
         <div id="loading-center">
            <div id="loading-center-absolute">
               ...
               <div class="tp-preloader-content">
                  ...
                  <h6 class="tp-preloader-title">𝓑𝓒öñ</h6>
         ...
         <div class="cartmini__wrapper d-flex justify-content-between flex-column">
             <div class="cartmini__top-wrapper">
                 ...
                 <div class="cartmini__shipping">
                  <p> Free Shipping for all orders over Rs <span>500</span></p>
                  <div class="progress">
                 ...
                 <div class="cartmini__widget">
                     <div class="cartmini__widget-item">
                         ...
                         <div class="cartmini__content">
                           ...
                           <h5 class="cartmini__title"><a href="product-details.html">Check out this product</a></h5>
                           <div class="cartmini__price-wrapper">
                              <span class="cartmini__price">Price</span>
                              <span class="cartmini__quantity">x Quantity</span>
                           </div>
                         </div>
                 ...
                 <div class="cartmini__empty text-center d-none">
                     ...
                     <a href="categories.php" class="tp-btn">Go to Shop</a>
                 </div>
             </div>
     ...
     <!-- cart mini area end -->
      ...
      <header>
         <div class="tp-header-area p-relative z-index-11">
                        ...
                        <div class="tp-header-top-right d-flex align-items-center justify-content-end">
                           <div class="tp-header-top-menu d-flex align-items-center justify-content-end">
                              ...
                              <div class="tp-header-top-menu-item tp-header-currency">
                                 <span class="tp-header-currency-toggle" id="tp-header-currency-toggle">INR</span>
                                 <ul>
                                    <li>
                                       <a href="#">INR</a>
                                    </li>
                              ...
                              <div class="tp-header-top-menu-item tp-header-setting">
                                ...
                                <?php
                                    ...
                                    ?>
                                        ...
                                        <li>
                                        <a href="logout.php">Logout    </a>  <!--Logout --> <!--<?= $_SESSION['auth_user']['name']; ?> -->
                                        </li>
                                ...
                                <?php
                                    ...
                                    {
                                    ?>
                                        <!-- otherwise Login Show bydefault -->
                                        <li>
               ...
               <div class="container">
                  <div class="row align-items-center">
                     <div class="col-xl-2 col-lg-2 col-md-4 col-6">
                        <div class="logo">
                           <a href="index.php">
                              <img src="assets/img/logo/logo.png" alt="logo" style="width:; height:40px;">
                           </a>
                        </div>
                     </div>
            ...
            <!-- here start: After registration Register and Login (in index.php file) are hide. and show the already regestered name. (before registration show Register and Login in index.php page.)  -->
                  <?php
                     if(isset($_SESSION['auth']))
                     {
                        ?>
                           ...
                           <div class="tp-header-login d-none d-lg-block">
                              <a href="profile.php" class="d-flex align-items-center">
                                 ...
                                 <div class="tp-header-login-content d-none d-xl-block">
                                    <span>Hello,</span>
                                    <h5 class="tp-header-login-title"> <?= $_SESSION['auth_user']['name']; ?> </h5> <!--Your Account-->
                                 </div>
                              </a>
                           </div>
                  ...
                  else
                  {
                     ...
                     ?>
                        ...
                        <div class="tp-header-login d-none d-lg-block">
                                 <a href="register.php" class="d-flex align-items-center">
                                    <!-- <div class="tp-header-login-icon">
                                       <span>
                                          <svg width="17" height="21" viewBox="0 0 17 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                             <circle cx="8.57894" cy="5.77803" r="4.77803" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                    ...
                                    <div class="tp-header-login-content d-none d-xl-block">
                                       ...
                                       <h5 class="tp-header-login-title" 
                                          style="transition: all 0.3s ease; padding: 10px; background-color: transparent; color: #333; text-align: center; cursor: pointer; text-transform: uppercase;"
                                          onmouseover="this.style.backgroundColor='#ff5722'; this.style.boxShadow='0 0 10px 2px rgba(255, 87, 34, 0.5)'; this.style.color='white';"
                                          onmouseout="this.style.backgroundColor='transparent'; this.style.boxShadow='none'; this.style.color='#333';">
                                          Register
                                       </h5>
                                       <!-- <h5 class="tp-header-login-title">Register</h5> -->
                                    </div>
                                 </a>
                              </div>
                              
                              <div class="tp-header-login d-none d-lg-block" style="padding-left:30px;">
                     ...
                     ?>
                           ...
                           <div class="tp-header-action d-flex align-items-center ml-50">
                              ...
                              <div class="tp-header-action-item d-none d-lg-block">
                                    <a href="my-orders.php" class="tp-header-action-btn">
                              ...
                              <nav class="tp-category-menu-content">
                               <ul>
                                   ...
                                   <li class="has-dropdown">
                                      <a href="categories.php" class="has-mega-menu">
                                         <span>
                                         ...
                                         <ul class="mega-menu tp-submenu">
                                            <li>
                                               <a href="categories.php" class="mega-menu-title">Featured</a>
                                               <ul>
                                                  <li>
                                                     <a href="categories.php"><img src="assets/img/header/menu/menu-1.jpg" alt=""></a>
                                                  </li>
                                                  <li>
                                                     <a href="categories.php">New Arrivals</a>
                                                  </li>
                                                  <li>
                                                     <a href="categories.php">Best Seller</a>
                                                  </li>
                                                  <li>
                                                     <a href="categories.php">Top Rated</a>
                                                  </li>
                                               </ul>
                                            </li>
     
                                            <li>
                                               <a href="categories.php" class="mega-menu-title">Computer & Laptops</a>
                                               <ul>
                                                  <li>
                                                   <a href="categories.php"><img src="assets/img/header/menu/menu-2.jpg" alt=""></a>
                                                  </li>
                                                  <li>
                                                     <a href="categories.php">Top Brands</a>
                                                  </li>
                                                  <li>
                                                     <a href="categories.php">Weekly Best Selling</a>
                                                  </li>
                                                  <li>
                                                     <a href="categories.php">Most Viewed</a>
                                                  </li>
                                               </ul>
                                            </li>
                                            <li>
                                               <a href="categories.php" class="mega-menu-title">Accessories</a>
                                               <ul>
                                                  <li>
                                                   <a href="categories.php"><img src="assets/img/header/menu/menu-3.jpg" alt=""></a>
                                                  </li>
                                                  <li>
                                                     <a href="categories.php">Headphones</a>
                                                  </li>
                                                  <li>
                                                     <a href="categories.php">TWS Earphone</a>
                                                  </li>
                                                  <li>
                                                     <a href="categories.php">Gaming Headset</a>
                                                  </li>
                                               </ul>
                                            </li>
                                   ...
                                   <li class="has-dropdown">
                                      <a href="categories.php">
                                         ...
                                         <ul class="tp-submenu">
                                            <li class="has-dropdown">
                                               <a href="categories.php">Desktop</a>
                                               <ul class="tp-submenu">
                                                  <li><a href="categories.php">Gaming</a></li>
                                                  <li><a href="categories.php">WorkSpace</a></li>
                                                  <li><a href="categories.php">Customize</a></li>
                                                  <li><a href="categories.php">Luxury</a></li>
                                               </ul>
                                            </li>
                                            <li><a href="categories.php">Laptop</a></li>
                                            <li><a href="categories.php">Console</a></li>
                                            <li><a href="categories.php">Top Rated</a></li>
                                         </ul>
                                   </li>
                                   <li>
                                      <a href="categories.php">
                        ...
                        <div class="col-xl-6 col-lg-6">
                           <div class="main-menu menu-style-1">
                              <nav class="tp-main-menu-content">
                                 <ul>
                                    <li class="has-mega-menu"> <!--has-dropdown-->
                                          ...
                                          <div class="row">
                                             <!-- <div class="col-lg-2">
                                                <div class="shop-mega-menu-list">
                                                      <a href="categories.php" class="shop-mega-menu-title">Shop Pages</a>
                                                      <ul>
                                                          <li><a href="categories.php">Grid Category</a></li>
                                                          <li><a href="categories.php">Grid Layout</a></li>
                                                          ...
                                                          <li><a href="categories.php">Left Sidebar</a></li>
                                             ...
                                             <div class="col-lg-2">
                                                <div class="shop-mega-menu-list">
                                                      <a href="categories.php" class="shop-mega-menu-title">Features</a>
                                                      <ul>
                                                         <li><a href="categories.php">Stock Availability</a></li>
                                                         <li><a href="categories.php">Featured Products</a></li>
                                                         <li><a href="categories.php">Discount Tags</a></li>
                                                         <li><a href="categories.php">Product Quick View</a></li>
                                                         <li><a href="categories.php">Product Categories</a></li>
                                                         <li><a href="categories.php">Collections list</a></li>
                                                         <li><a href="categories.php">Trending Products</a></li>
                                                         <li><a href="categories.php">Shipping Information</a></li>
                                                      </ul>
                                                </div>
                                             </div>
                                             <!-- <div class="col-lg-2">
                                                <div class="shop-mega-menu-list">
                                                      <a href="categories.php" class="shop-mega-menu-title">Hover Style</a>
                                                      <ul>
                                                         <li><a href="categories.php">Hover Style 1</a></li>
                                                         <li><a href="categories.php">Hover Style 2</a></li>
                                                         <li><a href="categories.php">Hover Style 3</a></li>
                                                         <li><a href="categories.php">Hover Style 4</a></li>
                                                      </ul>
                                                </div>
                                             </div> -->
                                             <div class="col-lg-3">
                                                <div class="shop-mega-menu-img">
                                                   ...
                                                   <div class="shop-mega-menu-btn">
                                                      <a href="categories.php" class="tp-menu-showcase-btn tp-menu-showcase-btn-2">Phones</a>
                                                   </div>
                                                </div>
                                             </div>
                                             <div class="col-lg-3">
                                                <div class="shop-mega-menu-img">
                                                   ...
                                                   <div class="shop-mega-menu-btn">
                                                      <a href="categories.php" class="tp-menu-showcase-btn tp-menu-showcase-btn-2">Cameras</a>
                                                   </div>
                                                </div>
                                             </div>
                                             <div class="col-lg-3">
                                                <div class="shop-mega-menu-img">
                                                   <img src="assets/img/menu/product/menu-product-img-3.jpg" alt="">
                                                   <div class="shop-mega-menu-btn">
                                                      <a href="categories.php" class="tp-menu-showcase-btn tp-menu-showcase-btn-2">Phones</a>
                                                   </div>
                                                </div>
                                    ...
                                    <li class="has-dropdown has-mega-menu ">
                                       ...
                                       <ul class="tp-submenu tp-mega-menu mega-menu-style-2">
                                          <!-- first col -->
                                          <li class="has-dropdown">
                                             <a href="categories.php" class="mega-menu-title">Shop Page</a>
                                             <ul class="tp-submenu">
                                                <li><a href="categories.php">Only Categories</a></li>
                                                <li><a href="categories.php">User Reviews</a></li>
                                                <li><a href="categories.php">Featured Products</a></li>
                                                <li><a href="categories.php">Discount Tags</a></li>
                                                <li><a href="categories.php">Sort By Price</a></li>
                                                <li><a href="categories.php">Product Details</a></li>
                                                <li><a href="categories.php">Product Details Progress</a></li>
                                             </ul>
                                          </li>
                                          <!-- third col -->
                                          <li  class="has-dropdown">
                                             ...
                                             <ul class="tp-submenu">
                                                ...
                                                <li><a href="categories.php">Trending Products</a></li>
                                                <li><a href="categories.php">Product Ratings</a></li>
                                                <li><a href="categories.php">Product Variants</a></li>
                                                <li><a href="categories.php">Mobiles</a></li>
                                                <li><a href="categories.php">Laptops</a></li>
                                                <li><a href="categories.php">Stock Status</a></li>
                                                <li><a href="categories.php">Shipping Details</a></li>
                                                <li><a href="categories.php">Customer Reviews</a></li>
                                             </ul>
                                          </li>
                                          <!-- third col -->
                                          <li  class="has-dropdown">
                                             <a href="categories.php" class="mega-menu-title">eCommerce</a>
                                             <ul class="tp-submenu">
                                          ...
                                          <!-- second col -->
                                          <li  class="has-dropdown">
                                             <a href="categories.php" class="mega-menu-title">More Pages</a>
                                             <ul class="tp-submenu">
                                    ...
                                    <li><a href="products.php">Coupons</a></li>
                                    <li class="has-dropdown">
                                       <a href="categories.php">Collection</a>
                                       <ul class="tp-submenu">
                                          <li><a href="categories.php">Popular Categories</a></li>
                                          <li><a href="categories.php">Trending Now</a></li>
                                          <li><a href="categories.php">New Arrivals</a></li>
                                          <li><a href="categories.php">Best Sellers</a></li>
                                          <li><a href="product-view.php">Customer Favorites</a></li>
                                       </ul>
                                    </li>
                        ...
                        <div class="col-xl-3 col-lg-3">
                           <div class="tp-header-contact d-flex align-items-center justify-content-end">
                              ...
                              <div class="tp-header-contact-content">
                                 <h5>Hotline:</h5>
                                 <p><a href="tel:402-763-282-46">+(91) 9339 024 892</a></p>
                              </div>
                           </div>
                        </div>
                     </div>
...
<!-- start: only for index.php page sticky navbar -->
...
<!-- End: only for index.php page sticky navbar -->