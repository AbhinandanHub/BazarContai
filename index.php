...
include('includes/index-slider.php'); 
...
<!-- <style>
    ...
    .owl-nav {
        ...
        pointer-events: none; /* Prevents interference with carousel items */
    }
    ...
    .owl-nav .owl-next {
        ...
        border-radius: 50%;
        cursor: pointer;
        pointer-events: all; /* Re-enable pointer events for arrows */
    }
    ...
    .owl-nav button {
        font-size: 20px; /* Increase the size of arrows */
    }
    ...
    .owl-dots .owl-dot.active span {
      ...
      <main>
         ...
         <section class="tp-product-category pt-60 pb-15">
            <div class="container custom1-container">
               ...
               <div class="owl-carousel owl-theme">
                     ...
                     // Start: it more than 2 or 7 words then autometically arise 'read more' after the words
                     if (!function_exists('limitWords_name')) {
                        function limitWords_name($text, $limit = 3) {
                           $words = explode(' ', $text);
                           if (count($words) > $limit) {
                              return implode(' ', array_slice($words, 0, $limit)) . '...<span style="color: red;">read more</span>';
                           }
                           return $text;
                        }
                     }
                     if (!function_exists('limitWords_desc')) {
                        function limitWords_desc($text, $limit = 5) {
                           $words = explode(' ', $text);
                           if (count($words) > $limit) {
                              return implode(' ', array_slice($words, 0, $limit)) . '...<span style="color: red;">read more</span>';
                           }
                     ...
                     // End: it more than 2 or 7 words then autometically arise 'read more' after the words
                                          ...
                                          <div class="tp-product-category-item text-center mb-40">
                                             <div class="tp-product-category-thumb fix">
                                                <a href="products.php?category=<?= $item['slug'];?>">
                                                   <img src="uploads/<?= $item['image'];?>" alt="product-category" style="width: 165px; height: 165px; border-radius: 50%; object-fit: cover;">
                                                </a>
                                             </div>
                                             <div class="tp-product-category-content">
                                                <h3 class="tp-product-category-title">
                                                <a href="products.php?category=<?= $item['slug'];?>"><?= limitWords_name($item['name']);?></a> 
                                                </h3>
                                                <!-- <p><a href="products.php?=<?= $item['slug'];?>"><?= $item['id'];?></a> products </p> -->
                                                <!-- <p><a href="products.php?category=<?= $item['slug']; ?>"><?= limitWords_desc($item['description']); ?>...read more</a></p> -->
                                                <p><a href="products.php?category=<?= $item['slug']; ?>" style="color: black; text-decoration: none;" onmouseover="this.style.color='red'" onmouseout="this.style.color='black'"><?= limitWords_desc($item['description']); ?></a></p>
                  ...
                  <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                     <div class="tp-feature-item d-flex align-items-start">
                        ...
                        <div class="tp-feature-content">
                           ...
                           <p>Onevery order over ₹8000.00</p>
                        </div>
                     </div>
                  </div>
                  <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
         ...
         <section class="tp-product-area pb-55">
            <div class="container">
               ...
               <div class="row">
                  ...
                  // Start: it more than 2 or 7 words then autometically arise 'read more' after the words
                  if (!function_exists('limitWords_title')) {
                     function limitWords_title($text, $limit = 5) {
                        $words = explode(' ', $text);
                        if (count($words) > $limit) {
                  ...
                  if (!function_exists('limitWords_desc')) {
                     function limitWords_desc($text, $limit = 10) {
                        $words = explode(' ', $text);
                        if (count($words) > $limit) {
                           return implode(' ', array_slice($words, 0, $limit)) . '... <a href="product-details.html">read more</a>';
                        }
                                    ...
                                    <div class="tp-product-item p-relative transition-3 mb-25">
                                       ...
                                       <div class="tp-product-content">
                                          <div class="tp-product-category">
                                             <a href="product-view.php?product=<?= $item['slug'];?>"><?= limitWords_title($item['name']);?></a> <!--Tablet -->
                                          </div>
                                          <h3 class="tp-product-title">
                                             <a href="product-view.php?product=<?= $item['slug'];?>">
                                             <?= limitWords_desc($item['description']);?><!-- Galaxy Tab S6 Lite 10.4-inch Android Tablet 128GB. -->
                                             </a>
                                          </h3>
                                          ...
                                          <div class="tp-product-price-wrapper">
                                             <span class="tp-product-price old-price"><?= $item['original_price']; ?></span>
                                             <span class="tp-product-price new-price"><?= $item['selling_price']; ?></span>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                  ...
                  <div class="col-xl-8 col-md-7 col-sm-6">
                     <div class="tp-product-offer-more-wrapper d-flex justify-content-sm-end p-relative z-index-1">
                        <div class="tp-product-offer-more mb-40 text-sm-end grey-bg-2">
                           <a href="categories.php" class="tp-btn tp-btn-2 tp-btn-blue">View All Deals 
                        ...
                        <div class="tp-product-offer-slider-active swiper-container">
                           <div class="swiper-wrapper">
                              <div class="tp-product-offer-item tp-product-item transition-3 swiper-slide">
                                 ...
                                 <div class="tp-product-content">
                                    <div class="tp-product-category">
                                       <a href="categories.php">HD Camera</a>
                                    </div>
                                    <h3 class="tp-product-title">
                                       <a href="product-details.html">
                     ...
                     <div class="tp-product-gadget-sidebar mb-40">
                        <div class="tp-product-gadget-categories p-relative fix mb-10">
                           ...
                           <div class="tp-product-gadget-categories-list">
                              <ul>
                                 <li><a href="categories.php">Micrscope</a></li>
                                 <li><a href="categories.php">Remote Control</a></li>
                                 <li><a href="categories.php">Monitor</a></li>
                                 <li><a href="categories.php">Thermometer</a></li>
                                 <li><a href="categories.php">Backpack</a></li>
                                 <li><a href="categories.php">Headphones</a></li>
                              </ul>
                           </div>

                           <div class="tp-product-gadget-btn">
                              <a href="categories.php" class="tp-link-btn">More Products 
                                 <svg width="15" height="13" viewBox="0 0 15 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M13.9998 6.19656L1 6.19656" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M8.75674 0.975394L14 6.19613L8.75674 11.4177" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                 </svg>
                        ...
                        <div class="row">
                           <div class="col-xl-4 col-sm-6">
                              <div class="tp-product-item p-relative transition-3 mb-25">
                                 ...
                                 <div class="tp-product-content">
                                    <div class="tp-product-category">
                                       <a href="categories.php">Electric</a>
                                    </div>
                                    <h3 class="tp-product-title">
                                       <a href="product-details.html">
                           ...
                           <div class="col-xl-4 col-sm-6">
                              <div class="tp-product-item p-relative transition-3 mb-25">
                                 ...
                                 <div class="tp-product-content">
                                    <div class="tp-product-category">
                                       <a href="categories.php">Tablet Pro 8</a>
                                    </div>
                                    <h3 class="tp-product-title">
                                       <a href="product-details.html">
                           ...
                           <div class="col-xl-4 col-sm-6">
                              <div class="tp-product-item p-relative transition-3 mb-25">
                                 ...
                                 <div class="tp-product-content">
                                    <div class="tp-product-category">
                                       <a href="categories.php">Headphone</a>
                                    </div>
                                    <h3 class="tp-product-title">
                                       <a href="product-details.html">
                           ...
                           <div class="col-xl-4 col-sm-6">
                              <div class="tp-product-item p-relative transition-3 mb-25">
                                 ...
                                 <div class="tp-product-content">
                                    <div class="tp-product-category">
                                       <a href="categories.php">Pertronix</a>
                                    </div>
                                    <h3 class="tp-product-title">
                                       <a href="product-details.html">
                           ...
                           <div class="col-xl-4 col-sm-6">
                              <div class="tp-product-item p-relative transition-3 mb-25">
                                 ...
                                 <div class="tp-product-content">
                                    <div class="tp-product-category">
                                       <a href="categories.php">Amazon</a>
                                    </div>
                                    <h3 class="tp-product-title">
                                       <a href="product-details.html">
                           ...
                           <div class="col-xl-4 col-sm-6">
                              <div class="tp-product-item p-relative transition-3 mb-25">
                                 ...
                                 <div class="tp-product-content">
                                    <div class="tp-product-category">
                                       <a href="categories.php">Medical</a>
                                    </div>
                                    <h3 class="tp-product-title">
                                       <a href="product-details.html">
                           ...
                           <div class="row align-items-center">
                              <div class="col-xl-6 col-lg-6">
                                 <div class="tp-product-banner-content p-relative z-index-1">
                                    <span class="tp-product-banner-subtitle">Tablet Collection 2024</span>
                                    ...
                                    <div class="tp-product-banner-btn">
                                       <a href="categories.php" class="tp-btn tp-btn-2">Shop now</a>
                                    </div>
                                 </div>
                              </div>
                              <div class="col-xl-6 col-lg-6">
                        ...
                        <div class="tp-product-arrival-active swiper-container">
                           <div class="swiper-wrapper">
                              <div class="tp-product-item transition-3 mb-25 swiper-slide">
                                 ...
                                 <div class="tp-product-content">
                                    <div class="tp-product-category">
                                       <a href="categories.php">Fast Charger</a>
                                    </div>
                                    <h3 class="tp-product-title">
                                       <a href="product-details.html">
                              ...
                              <div class="tp-product-item transition-3 mb-25 swiper-slide ">
                                 ...
                                 <div class="tp-product-content">
                                    <div class="tp-product-category">
                                       <a href="categories.php">Earbuds</a>
                                    </div>
                                    <h3 class="tp-product-title">
                                       <a href="product-details.html">
                              ...
                              <div class="tp-product-item transition-3 mb-25 swiper-slide ">
                                 ...
                                 <div class="tp-product-content">
                                    <div class="tp-product-category">
                                       <a href="categories.php">Tablet</a>
                                    </div>
                                    <h3 class="tp-product-title">
                                       <a href="product-details.html">
                     ...
                     <div class="tp-product-sm-list mb-50">
                        ...
                        <div class="tp-product-sm-wrapper mr-20">
                           ...
                           <div class="tp-product-sm-item d-flex align-items-center">
                              ...
                              <div class="tp-product-sm-content">
                                 <div class="tp-product-category">
                                    <a href="categories.php">Iron Man</a>
                                 </div>
                                 <h3 class="tp-product-title">
                           ...
                           <div class="tp-product-sm-item d-flex align-items-center">
                              ...
                              <div class="tp-product-sm-content">
                                 <div class="tp-product-category">
                                    <a href="categories.php">Speaker</a>
                                 </div>
                                 <h3 class="tp-product-title">
                     ...
                     <div class="tp-product-sm-list mb-50">
                        ...
                        <div class="tp-product-sm-wrapper mr-20">
                           <div class="tp-product-sm-item d-flex align-items-center">
                              ...
                              <div class="tp-product-sm-content">
                                 <div class="tp-product-category">
                                    <a href="categories.php">Motherboard</a>
                                 </div>
                                 <h3 class="tp-product-title">
                           ...
                           <div class="tp-product-sm-item d-flex align-items-center">
                              ...
                              <div class="tp-product-sm-content">
                                 <div class="tp-product-category">
                                    <a href="categories.php">Digital Camera</a>
                                 </div>
                                 <h3 class="tp-product-title">
                           ...
                           <div class="tp-product-sm-item d-flex align-items-center">
                              ...
                              <div class="tp-product-sm-content">
                                 <div class="tp-product-category">
                                    <a href="categories.php">Smart Watches</a>
                                 </div>
                                 <h3 class="tp-product-title">
                     ...
                     <div class="tp-product-sm-list mb-50">
                        ...
                        <div class="tp-product-sm-wrapper mr-20">
                           <div class="tp-product-sm-item d-flex align-items-center">
                              ...
                              <div class="tp-product-sm-content">
                                 <div class="tp-product-category">
                                    <a href="categories.php">Usb Flash Disk</a>
                                 </div>
                                 <h3 class="tp-product-title">
                           ...
                           <div class="tp-product-sm-item d-flex align-items-center">
                              ...
                              <div class="tp-product-sm-content">
                                 <div class="tp-product-category">
                                    <a href="categories.php">HawkEye</a>
                                 </div>
                                 <h3 class="tp-product-title">
