...
if($category){
   ...
   $c_id=$category['id']; //here, C_id is a veriable 
   ?>
            <main>
                        ...
                        <div class="col-xxl-12">
                           <div class="breadcrumb__content p-relative z-index-1">
                              ...
                              <div class="breadcrumb__list">
                                 ...
                                 <span><a href="products.php"><?= $category['name'];?></a></span>
                                       ...
                                       <div class="row">
                                          ...
                                          <div class="col-xxl-3 col-xl-4 col-lg-4 col-sm-6">
                                             <div class="tp-product-item-2 mb-40">
                                                ...
                                                <!--Start: here i fatch the products --> 
      <?php
            ...
            ?>
                                          <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                                             <div class="tp-product-item-2 mb-40">
                                                ...
                                                <div class="tp-product-content-2 pt-15">
                                                   <div class="tp-product-tag-2">
                                                      <a href="product-view.php?product=<?= $item['slug'];?>"><?= $item['name'];?></a> <!--Whitetails Store-->
                                                   </div>
                                                   <h3 class="tp-product-title-2">
...
<!-- some concepts of this page  -->
 <!-- this is the main product fatch coding -->
<!-- <?php
// $products = getProdByCategory("$c_id");
